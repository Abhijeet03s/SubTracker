         ...
         <div className="bg-rich-black text-white flex-grow flex flex-col justify-start md:justify-center items-center px-4 sm:px-6 lg:px-8 relative overflow-hidden w-full py-4 sm:py-8 md:py-12 lg:py-16">
            <div className="max-w-7xl mx-auto w-full text-center relative z-10 bg-grid bg-grid-mask">
               ...
               <div className="flex flex-row justify-center items-center gap-4 mb-8 sm:mb-10 md:mb-12">
                  {userId ? (
                     <Link href="/dashboard" className={`${plusJakartaSans.className} bg-purple-700 hover:bg-purple-800 text-white font-medium py-2 px-4 sm:px-8 sm:py-3 rounded-full transition duration-300 ease-in-out text-sm sm:text-lg flex items-center justify-center group`}>
                        Dashboard
                     ...
                     <Link href="/sign-up" className={`${plusJakartaSans.className} bg-purple-700 hover:bg-purple-800 text-white font-medium py-2 px-4 sm:px-8 sm:py-3 rounded-full transition duration-300 ease-in-out text-sm sm:text-lg flex items-center justify-center group`}>
                        Start Tracking
                        <FaArrowRight className="ml-3 transform translate-x-0 group-hover:translate-x-1 transition-transform duration-300 ease-in-out" />
                     </Link>
                  )}
                  <Link href="#demo" className={`${plusJakartaSans.className} bg-white hover:bg-gray-100 text-black font-medium py-2 px-4 sm:px-8 sm:py-3 rounded-full border border-black transition duration-300 ease-in-out text-sm sm:text-lg flex items-center justify-center`}>
                     Learn More
                  </Link>
               </div>
