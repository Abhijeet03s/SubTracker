         ...
         <div className="bg-rich-black text-white flex-grow flex flex-col justify-start md:justify-center items-center px-8 sm:px-6 lg:px-8 relative overflow-hidden w-full py-12 sm:py-16 md:py-20 lg:py-24 bg-grid bg-grid-mask">
            <div className="w-full max-w-[90%] sm:max-w-7xl mx-auto text-center relative z-10">
               ...
               <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-4 mb-12 sm:mb-14 md:mb-16">
                  {userId ? (
                     <Link href="/dashboard" className={`${plusJakartaSans.className} bg-purple-700 hover:bg-purple-800 text-white text-base sm:text-base font-medium py-4 sm:py-2 px-8 sm:px-4 rounded-full transition duration-300 ease-in-out flex items-center justify-center group h-14 w-full sm:w-52`}>
                        Dashboard
                     ...
                     <Link href="/sign-up" className={`${plusJakartaSans.className} bg-purple-700 hover:bg-purple-800 text-white text-base sm:text-base font-medium py-4 sm:py-2 px-8 sm:px-4 rounded-full transition duration-300 ease-in-out flex items-center justify-center group h-14 w-full sm:w-52`}>
                        Start Tracking
                  ...
                  <Link href="#demo" className={`${plusJakartaSans.className} bg-white hover:bg-gray-100 text-black text-base sm:text-base font-medium py-4 sm:py-2 px-8 sm:px-4 rounded-full border border-black transition duration-300 ease-in-out flex items-center justify-center group h-14 w-full sm:w-52`}>
                     Learn More
