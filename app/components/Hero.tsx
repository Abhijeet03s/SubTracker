      ...
      <section className="min-h-screen flex flex-col overflow-hidden">
         <div className="bg-rich-black text-white flex-grow flex flex-col justify-start md:justify-center items-center px-8 sm:px-6 lg:px-8 relative overflow-hidden w-full py-12 sm:py-16 md:py-20 lg:py-24 bg-grid bg-grid-mask">
            <div className="w-full max-w-md sm:max-w-7xl mx-auto text-center relative z-10">
               ...
               >
                  <motion.span className="block" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.5 }}>Never Miss a</motion.span>
                  <motion.span className="block mt-0 md:mt-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.8 }}>Subscription Renewal</motion.span>
                  <motion.span className="block mt-0 md:mt-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 1.1 }}>
                     Again
                     <motion.span
            ...
            <motion.div
               className="relative w-full max-w-xl sm:max-w-7xl mx-auto overflow-hidden"
