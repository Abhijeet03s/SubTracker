...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-noise-and-lines text-white flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 relative overflow-hidden py-20">
      <div className="max-w-7xl mx-autow-full text-center relative z-10">
        <h1 className={`${zillaSlab.className} text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#9433e9] to-[#33e9e4]`}>
          SubTrack
        </h1>
